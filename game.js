...
function collideY(o) {
  ...
  if (o.vy > 0) {
    ...
    for (var tx = tx0; tx <= tx1; tx++) {
      ...
      if (c === 16 && o.prevY + o.h <= ty * T + 8) {
        o.y = ty * T - o.h - 0.01;
        o.vy = 0;
        o.ground = true;
        o.hitB = true;
        if (o === PL) triggerCrumble(tx, ty);
        break;
      }
      if (solid(c)) {
        o.y = ty * T - o.h - 0.01;
      ...
      if (c === 9 && o.prevY + o.h <= ty * T + 6 && o.vy >= 0) {
        o.y = ty * T - o.h - 0.01;
        o.vy = 0;
        o.ground = true;
        o.hitB = true;
  ...
  if (AIB.mode === "backoff") {
    ...
    for (var ti2 = 0; ti2 < itms.length; ti2++) {
      ...
      var ddx = im.x + 10 - px,
        ddy = im.y + 11 - feet,
        ad = Math.abs(ddx);
      if (ad < 300 && ddy > -200 && ddy < 130 && ad < bd) {
        bd = ad;
        tgt = im;
      }
    }
    if (tgt) {
      keys.right = ddx > 4;
      keys.left = ddx < -4;
      if (tgt.y + 11 < feet - 44 && Math.abs(ddx) < 80 && p.ground) {
        wantJump = true;
        hold = 0.4;
      }
    }
